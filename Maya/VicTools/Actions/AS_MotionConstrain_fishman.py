...
def HIKMotionProcess(toolroot,charPath,savePath,rigNameSpace): #toolroot = "E:/00Trunk/PY/JoyFunToolSetMaya/00tools/AdvancedSkeleton/scripts/" , # charPath = 
	...
	if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK):
		...
		for ff in allF: #ff = allF[0] len(allF)
			...
			['FKFinShoulder_L','FinShoulder_L'],
			['FKFinShoulder1_L','FinShoulder1_L'],
			['FKFinShoulder1_L','FinShoulder1_L'],

			['FKFinShoulder_R','FinShoulder_R'],
			['FKFinShoulder1_R','FinShoulder1_R'],
			['FKFinShoulder1_R','FinShoulder1_R'],

			['FKFinTail_L','FinTail_L'],
			['FKFinTail1_L','FinTail1_L'],
			['FKFinTail2_L','FinTail2_L'],

			['FKFinTail_R','FinTail_R'],
			['FKFinTail1_R','FinTail1_R'],
			['FKFinTail2_R','FinTail2_R'],
			['FKTail12_M','Tail11_M'],
			...
			['IKSplineTail1_M','Tail0_M'],
			['IKSplineTail2_M','Tail4_M'],
			['IKSplineTail3_M','Tail7_M'],
			['IKSplineTail4_M','Tail11_M'],]
			extraNodeToBake=[]
